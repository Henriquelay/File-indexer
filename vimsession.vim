...
exe 'vert 1resize ' . ((&columns * 78 + 119) / 239)
exe '2resize ' . ((&lines * 40 + 31) / 63)
exe 'vert 2resize ' . ((&columns * 160 + 119) / 239)
exe '3resize ' . ((&lines * 20 + 31) / 63)
exe 'vert 3resize ' . ((&columns * 160 + 119) / 239)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((12 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
