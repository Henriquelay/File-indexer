...
badd +1 src/main.c
badd +0 src/lista.c
badd +0 src/palavra.c
badd +0 headers/palavra.h
badd +0 headers/lista.h
argglobal
silent! argdel *
$argadd src/main.c
edit src/main.c
...
exe 'vert 1resize ' . ((&columns * 65 + 119) / 239)
exe '2resize ' . ((&lines * 30 + 31) / 63)
exe 'vert 2resize ' . ((&columns * 64 + 119) / 239)
exe '3resize ' . ((&lines * 30 + 31) / 63)
exe 'vert 3resize ' . ((&columns * 130 + 119) / 239)
...
wincmd w
argglobal
if bufexists('headers/palavra.h') | buffer headers/palavra.h | else | edit headers/palavra.h | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>GitGutterPrevHunk
nmap <buffer> \hp <Plug>GitGutterPreviewHunk
...
wincmd w
argglobal
if bufexists('src/palavra.c') | buffer src/palavra.c | else | edit src/palavra.c | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>GitGutterPrevHunk
nmap <buffer> \hp <Plug>GitGutterPreviewHunk
...
wincmd w
argglobal
if bufexists('headers/lista.h') | buffer headers/lista.h | else | edit headers/lista.h | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>GitGutterPrevHunk
nmap <buffer> \hp <Plug>GitGutterPreviewHunk
...
wincmd w
argglobal
if bufexists('src/lista.c') | buffer src/lista.c | else | edit src/lista.c | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>GitGutterPrevHunk
nmap <buffer> \hp <Plug>GitGutterPreviewHunk
