...
exe 'vert 1resize ' . ((&columns * 70 + 95) / 191)
exe '2resize ' . ((&lines * 30 + 26) / 53)
exe 'vert 2resize ' . ((&columns * 70 + 95) / 191)
exe 'vert 3resize ' . ((&columns * 50 + 95) / 191)
exe '4resize ' . ((&lines * 20 + 26) / 53)
exe 'vert 4resize ' . ((&columns * 69 + 95) / 191)
exe '5resize ' . ((&lines * 30 + 26) / 53)
exe 'vert 5resize ' . ((&columns * 69 + 95) / 191)
argglobal
let s:cpo_save=&cpo
set cpo&vim
