...
set shortmess=aoO
badd +23 src/arquivos.c
badd +25 src/main.c
badd +13 headers/arquivos.h
badd +70 src/lista.c
badd +15 headers/lista.h
badd +4 data/Teste-SA.txt
argglobal
silent! argdel *
...
silent! normal! zE
let s:l = 24 - ((17 * winheight(0) + 12) / 25)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 12 - ((0 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
12
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 69 - ((20 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
69
